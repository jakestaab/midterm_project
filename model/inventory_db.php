...
class InventoryDB {
    public static function get_vehicles($price_or_year, $make_id, $type_id, $class_id) {
        $db = Database::getDB();
    ...
    public static function delete_vehicle($v_num) {
        $db = Database::getDB();
    ...
    public static function add_vehicle($year, $model, $price, $type_id, $class_id, $make_id) {
        $db = Database::getDB();
